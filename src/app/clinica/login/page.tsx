...
export default function ClinicaLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    setError('')
    const res = await fetch('/api/clinica/auth', {
      method: 'POST',
    ...
    if (res.ok) {
      ...
      if (data.primeiraSenha) {
        router.push('/clinica/perfil?trocar_senha=1')
      } else {
    ...
    <div className="min-h-screen bg-[#19202d] flex items-center justify-center px-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
        ...
        <div className="px-8 py-7">
          <p className="text-sm text-gray-400 mb-5 text-center">Acesse o portal da sua clínica</p>
