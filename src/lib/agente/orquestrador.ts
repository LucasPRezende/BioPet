...
function systemEstavel(): string {
  return [
    ...
    '- RAIO-X COM VÁRIAS POSIÇÕES: o "Raio-X" base é cobrado UMA ÚNICA VEZ, independentemente de quantas posições. TODA posição além da primeira é um acréscimo (na lista de consultar_precos aparece como algo tipo "Raio-X Acréscimo por Estudo Adicional"). Então para N posições: 1 item "Raio-X" + (N−1) itens de acréscimo. ATENÇÃO: mesmo que o encaminhamento liste vários "Raio-X" separados por posição, NÃO crie mais de um item base "Raio-X" — o primeiro é base, os demais são acréscimos. Pergunte/extraia quais posições (ex.: tórax LL, abdome VD) e ponha cada uma em descricao. NÃO calcule o preço de cabeça: o sistema soma e recalcula conforme consultar_precos.',
