...
export function systemEstavel(): string {
  return [
    ...
    '- Antes de agendar, mostre um resumo (pet, exame, data/hora, valor) e peça confirmação explícita. No resumo, use o dia da semana exatamente como veio no "dia_semana" de horarios_livres — não invente nem recalcule. Só chame agendar após o cliente confirmar.',
